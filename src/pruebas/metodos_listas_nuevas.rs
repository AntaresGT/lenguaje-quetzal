...
imprimir(numeros)
    ...
    fn test_ordenar_cadenas() {
        let codigo = r#"
lista var nombres = ["Carlos", "Ana", "Beatriz"]
nombres.ordenar()
imprimir(nombres)
        "#;
...
imprimir(numeros)
    ...
    fn test_asignacion_indice_cadenas() {
        let codigo = r#"
lista var frutas = ["manzana", "banana", "naranja"]
frutas[1] = "kiwi"
imprimir(frutas)
        "#;
...
imprimir(numeros)
    ...
    fn test_agregar_diferentes_tipos() {
        let codigo = r#"
lista var mixta = ["uno", "dos"]
mixta.agregar(3.texto())
...
imprimir(mixta)
    ...
    fn test_compatibilidad_longitud_cadena_lista() {
        let codigo = r#"
texto mi_texto = "Hola Quetzal"
lista numeros = [10, 20, 30]
entero longitud_texto = mi_texto.longitud()
...
log texto_vacio_result = texto_vacio.esta_vacia()
log texto_lleno_result = texto_lleno.esta_vacia()
...
imprimir(datos)
    ...
    fn test_lista_mixta_con_metodos() {
        let codigo = r#"
lista var mixta = [1, "texto", verdadero, 3.14]
